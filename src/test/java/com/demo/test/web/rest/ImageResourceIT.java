...
import com.demo.test.domain.Image;
import com.demo.test.repository.ImageRepository;
...
class ImageResourceIT {
    ...
    public static Image createEntity(EntityManager em) {
        Image image = new Image().data(DEFAULT_DATA).dataContentType(DEFAULT_DATA_CONTENT_TYPE);
        return image;
    }
    ...
    public static Image createUpdatedEntity(EntityManager em) {
        Image image = new Image().data(UPDATED_DATA).dataContentType(UPDATED_DATA_CONTENT_TYPE);
        return image;
    }
    ...
    void putNewImage() throws Exception {
        ...
        updatedImage.data(UPDATED_DATA).dataContentType(UPDATED_DATA_CONTENT_TYPE);
    ...
    void fullUpdateImageWithPatch() throws Exception {
        ...
        partialUpdatedImage.data(UPDATED_DATA).dataContentType(UPDATED_DATA_CONTENT_TYPE);
