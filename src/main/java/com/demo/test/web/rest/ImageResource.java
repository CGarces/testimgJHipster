...
import com.demo.test.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.demo.test.domain.Image}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Image> result = imageRepository
            ...
            .map(
                existingImage -> {
                    ...
                    if (image.getDataContentType() != null) {
                        existingImage.setDataContentType(image.getDataContentType());
                    }
